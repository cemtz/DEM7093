...
st_geometry(pov19) <- NULL #usuallys drops geometry of right df, dplyr is usually faster, but only one df can have geometry
mdat2 <- left_join(pov10, pov19, by = c("GEOID"="GEOID"))
